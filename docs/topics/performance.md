...
| Lighting | Fixed tile and shadow-atlas partitions bound pressure; workgroups share projected light bounds, caster culling and early rejection avoid unnecessary work, and environment lobes share probe weights. |
