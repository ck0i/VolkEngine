...
| Lighting | Fixed tile and shadow-atlas partitions bound pressure; shadow views cache hierarchically culled caster lists and bypass fragment shading when no alpha mask is present. |
