...
| Lighting | Fixed tile and shadow-atlas partitions bound pressure; hierarchical caster culling and early local-light rejection avoid unnecessary shadow and BRDF work. |
