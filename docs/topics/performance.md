...
| Scene data | Reusable extraction and frame-slot arrays avoid rebuilding unchanged records; covered material grids reuse revision-keyed GPU records and capacity counts, and material features are normalized once into GPU bit patterns. |
