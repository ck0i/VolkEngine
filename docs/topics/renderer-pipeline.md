...
The HDR path uses GGX/Smith/Schlick lighting, an equirectangular environment mip chain, up to four reflection probes, packed material classes, analytic atmosphere, and material-specific foliage/landscape/water branches. Tonemapping applies exposure, ACES, and exactly one sRGB encoding step.
