...
set(VOLKENGINE_CGLTF_VERSION "1.15" CACHE STRING "Pinned cgltf version")
...
function(volkengine_resolve_cgltf)
    FetchContent_Declare(cgltf
        URL "https://github.com/jkuhlmann/cgltf/archive/refs/tags/v${VOLKENGINE_CGLTF_VERSION}.zip"
        URL_HASH "SHA256=a2f5f6db978fd269a107e9284f4a7bac5d1132cd7cc5e6464e60c8aff81001d1"
        DOWNLOAD_EXTRACT_TIMESTAMP TRUE)
    FetchContent_MakeAvailable(cgltf)
    FetchContent_GetProperties(cgltf)
    add_library(VolkEngineCgltf INTERFACE)
    target_include_directories(VolkEngineCgltf INTERFACE "${cgltf_SOURCE_DIR}")
    set(VOLKENGINE_CGLTF_TARGET VolkEngineCgltf PARENT_SCOPE)
    message(STATUS "Using cgltf ${VOLKENGINE_CGLTF_VERSION} (MIT, header-only glTF 2.0 parser)")
endfunction()
...
function(volkengine_resolve_dependencies)
    ...
    set(VOLKENGINE_CGLTF_TARGET "${VOLKENGINE_CGLTF_TARGET}" PARENT_SCOPE)
